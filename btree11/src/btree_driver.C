...
void BTreeTest::test1() {
	...
	cout << "start BTreeIndex insertion" << endl << endl;
	...
	if(status == OK)
		cout<<" BTreeIndex opened successfully." << endl << endl;

	// test scan and delete_current()
	cout << "----------- Testing scans -------------" << endl;
	lokey = 200;
	hikey = 400;
...
bool sort_dummy4_by_value1(const DummyTest4 a, const DummyTest4 b) {
	return a.sort_value1 < b.sort_value1;
}

bool sort_dummy4_by_value2(const DummyTest4 a, const DummyTest4 b) {
	return a.sort_value2 < b.sort_value2;
}
...
void BTreeTest::test4() {
	...
	sort(values, values + num, sort_dummy4_by_value1);
	...
	sort(values, values + num, sort_dummy4_by_value2);
